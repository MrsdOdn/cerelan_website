    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_passengers', models.PositiveIntegerField(default=0, max_length=3)),
                ('route', models.CharField(blank=True, max_length=100, null=True)),
                ('note', models.TextField(blank=True, max_length=200, null=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shared_cars', to=settings.AUTH_USER_MODEL)),
            ],
            options={
